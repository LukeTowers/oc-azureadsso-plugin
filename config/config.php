<?php return [
    ...
    //This key is optional. The subdomain should be replaced with the real subdomain name
    'subdomain' => [
        'laravel/socialite' => [
            'providers' => [
                '\Laravel\Socialite\SocialiteServiceProvider',
        ...
        'metrogistics/laravel-azure-ad-oauth' => [
            ...
            'config' => [
                ...
                'credentials' => [
                    'client_id'     => env('AZURE_AD_subdomain_CLIENT_ID', ''),
                    'client_secret' => env('AZURE_AD_subdomain_CLIENT_SECRET', ''),
                    'redirect'      => Request::root().'/luketowers/azureadsso/login/microsoft/callback'
                ],
